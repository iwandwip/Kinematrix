#ifndef INTERACTIVE_SERIAL_GENERAL_SENSOR_CALIBRATOR_V2_H
#define INTERACTIVE_SERIAL_GENERAL_SENSOR_CALIBRATOR_V2_H
...
class InteractiveSerialGeneralSensorCalibratorV2 {
public:
...
private:
    ...
    String _inputBuffer;
    bool _inputComplete;
    unsigned long _inputStartTime;

    void *_inputResultPtr;

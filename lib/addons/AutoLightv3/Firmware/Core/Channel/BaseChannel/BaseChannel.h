...
#include "../../Interaction/ButtonInterrupt.h"
#include "../../Cores/Task.h"
#include "../../../API/APIServerManager.h"
...
#define SET_ACTIVE_SEQUENCES(channel, ...) \
        ...
        APIServerManager *getAPIManager() { return web_manager_; }
        ...
        void taskSequence16DualSideSequential();
        void taskSequence17MirrorPattern();

...
namespace AutoLight {
    ...
    void BaseChannel::setTaskSequenceFunction() {
        ...
        total_mode_[16] = &BaseChannel::taskSequence16DualSideSequential;
        total_mode_[17] = &BaseChannel::taskSequence17MirrorPattern;
    }
    ...
    void BaseChannel::enableWebServer(bool auto_task) {
        ...
        if (web_manager_ == nullptr) {
            ...
            web_manager_ = new APIServerManager(this, config);
            if (config != nullptr) {
